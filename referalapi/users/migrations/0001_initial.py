# Generated by Django 4.2.16 on 2024-10-17 06:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(max_length=80, unique=True, verbose_name='E-mail')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('referal', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='referal', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('live_days', models.PositiveIntegerField()),
        ...
        migrations.AddConstraint(
            model_name='refers',
            constraint=models.UniqueConstraint(fields=('referer', 'referal'), name='unique_refer'),
        ),
        migrations.AddConstraint(
            model_name='codes',
            constraint=models.UniqueConstraint(fields=('code', 'user'), name='unique_refer_codes'),
        ),
    ]
